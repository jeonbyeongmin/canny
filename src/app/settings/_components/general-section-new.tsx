  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b border-slate-200 pb-6">
        <h1 className="text-3xl font-bold text-slate-900 mb-2">일반 설정</h1>
        <p className="text-slate-600">계정 정보, 알림, 언어 및 기타 설정을 관리하세요</p>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-800">계정 정보</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-2">
            ...
            <input
              ...
              className="w-full h-11 px-4 rounded-lg border border-slate-200 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200"
            />
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">회사/조직</label>
            <input
              type="text"
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">시간대</label>
            <select
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-800">알림 설정</h2>
        </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-800">언어 및 지역</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full h-11 px-4 rounded-lg border border-slate-200 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 bg-white"
            >
              {languages.map((lang) => (
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">날짜 형식</label>
            <select
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">시간 형식</label>
            <select
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-800">뉴스레터 기본 설정</h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">발송 빈도</label>
            <select
              ...
              className="w-full h-11 px-4 rounded-lg border border-slate-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 bg-white"
            >
          ...
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">발송 시간</label>
            <input
              type="time"
              ...
              className="w-full h-11 px-4 rounded-lg border border-slate-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <label className="block text-sm font-medium text-slate-700">최대 기사 수</label>
            <input
              type="number"
              min="1"
              max="20"
          ...
          <div className="flex items-center">
            <label className="flex items-center cursor-pointer">
              ...
              <span className="ml-3 text-sm font-medium text-slate-700">요약 포함</span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-8 shadow-sm">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h2 className="text-xl font-semibold text-slate-800">데이터 관리</h2>
        </div>

        <div className="space-y-6">
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-lg">
            <div>
              <span className="text-sm font-medium text-slate-800">데이터 내보내기</span>
              <p className="text-xs text-slate-600 mt-1">내 설정과 데이터를 JSON 파일로 다운로드</p>
            </div>
            <button
          ...
          <div className="flex items-center justify-between p-4 bg-red-50 rounded-lg border border-red-200">
            <div>
              <span className="text-sm font-medium text-red-800">계정 삭제</span>
